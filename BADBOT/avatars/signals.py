...
def create_data(apps, sender, **kwargs):
    ...
    if sender.name == 'avatars':
        ...
        create.index_text_2 = '<h1>Пример текста h1</h1>\n'
        create.index_text_2 += '<h2>Пример текста h2</h2>\n'
        create.index_text_2 += '<h3>Пример текста h3</h3>\n'
        create.index_text_2 += '<h4>Пример текста h4</h4>\n'

        create.index_text_2 += '<p>Пример текста p</p>\n'
        create.index_text_2 += '<p>Пример <i>*наклонного</i> текста p</p>\n'
        create.index_text_2 += '<p>Пример <b>жирного</b> текста p</p>\n'

        create.index_text_2 += '<p>Это: <a href="http://127.0.0.1:8000/">внутренняя ссылка</a></p>\n'
        create.index_text_2 += '<p>Это: <a href="http://127.0.0.1:8000/" target="_blank">внешняя ссылка</a></p>\n'

        create.index_text_2 += '<img src="/media/design/content/index-1.jpg">\n'                 # обычная картинка
        create.index_text_2 += '<img id="big-image" src="/media/design/content/index-1.jpg">\n'  # большая картинка
